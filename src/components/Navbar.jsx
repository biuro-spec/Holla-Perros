  ...
  return (
    <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, backgroundColor: navBg, borderBottom: navBorder, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 60px', backdropFilter: navBlur, WebkitBackdropFilter: navBlur, boxShadow: navShadow, transition: 'all 0.4s ease', overflow: 'visible' }}>
      ...
      <div className="navbar-links" style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
        ...
        <a href="#sklepik" className="nav-link" style={{ textDecoration: 'none', color: 'var(--text-dark)', fontWeight: 400, fontSize: '0.9rem', letterSpacing: '1px', textTransform: 'uppercase' }}>Sklepik</a>
        <Link to="/metamorfozy" className="nav-link" style={{ textDecoration: 'none', color: '#B83D5E', fontWeight: 600, fontSize: '0.9rem', letterSpacing: '1px', textTransform: 'uppercase' }}>Metamorfozy</Link>
      ...
      {isOpen && (
        <div style={{ position: 'absolute', top: '100%', left: 0, right: 0, backgroundColor: 'var(--bg-color)', borderBottom: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', padding: '30px 20px', gap: '24px', boxShadow: '0 10px 20px rgba(0,0,0,0.05)' }}>
          ...
          <a href="#sklepik" onClick={() => setIsOpen(false)} style={{ textDecoration: 'none', color: 'var(--text-dark)', fontWeight: 400, fontSize: '1.2rem', letterSpacing: '1px', textTransform: 'uppercase', textAlign: 'center' }}>Sklepik</a>
          <Link to="/metamorfozy" onClick={() => setIsOpen(false)} style={{ textDecoration: 'none', color: '#B83D5E', fontWeight: 600, fontSize: '1.2rem', letterSpacing: '1px', textTransform: 'uppercase', textAlign: 'center' }}>Metamorfozy</Link>
