export const blogPosts = [
  {
    id: 'pierwsza-wizyta',
    title: 'Pierwsza wizyta u groomera – jak przygotować szczeniaka bez stresu?',
    ...
    imageUrl: './zdjecia/blog/groomer-raciborz-pierwsza-wizyta-szczeniaka.webp?v=2',
    content: `
      ...
      <ul>
        ...
        <li><strong>Przyzwyczajanie do grzebienia:</strong> Czesanie powinno być chwilą relaksu, a nie walką. Używaj miękkiej szczotki i obficie nagradzaj malucha.</li>
      </ul>
  ...
  {
    id: 'kapiel-w-domu',
    title: 'Kąpiel psa w domu: 5 najczęstszych błędów, których musisz unikać',
    ...
    imageUrl: './zdjecia/blog/kapiel-psa-w-domu-raciborz.webp?v=2',
    content: `
  ...
  {
    id: 'trymowanie-a-strzyzenie',
    title: 'Trymowanie a strzyżenie – na czym polega różnica i czego potrzebuje Twój pies?',
    ...
    imageUrl: './zdjecia/blog/trymowanie-a-strzyzenie-psa.webp?v=2',
    content: `
      ...
      <ul>
        <li>Utrata koloru (włos staje się wypłowiały).</li>
        <li>Zmiana struktury (z twardej "szczotki", chroniącej przed deszczem i brudem, powstaje miękki puszek).</li>
        <li>Problemy skórne – martwy włos, który został tylko obcięty, a nie usunięty, zapycha pory i może prowadzić do zapaleń.</li>
      </ul>
  ...
  {
    id: 'psie-spa-maski',
    title: 'Psie SPA: Dlaczego maski i masełka to nie fanaberia, ale inwestycja w zdrowie.',
    ...
    imageUrl: './zdjecia/blog/psie-spa-maska-pielegnacja-raciborz.webp?v=2',
    content: `
  ...
  {
    id: 'higiena-zebow',
    title: 'Ultradźwiękowe czyszczenie zębów bez narkozy – czy to bezpieczne?',
    excerpt: 'Dowiedz się, na czym polega rewolucyjna metoda kosmetycznego czyszczenia psiego uśmiechu.',
    date: '25 Maj 2026',
    category: 'Zdrowie',
    imageUrl: './zdjecia/blog/czyszczenie-zebow-psa-raciborz.webp?v=2',
    content: `
  ...
  {
    id: 'kołtuny-u-psa',
    title: 'Kołtuny u psa – jak zapobiegać i czy zawsze trzeba golić na krótko?',
    excerpt: 'Filce i splątania to zmora wielu opiekunów. Czy istnieje ratunek przed maszynką?',
    date: '28 Maj 2026',
    category: 'Wiedza Groomerska',
    imageUrl: './zdjecia/blog/koltuny-u-psa-grooming-raciborz.webp?v=2',
    content: `
  ...
  },
  {
    ...
    imageUrl: './zdjecia/blog/strzyzenie-pudla-doodle-raciborz.webp?v=2',
    content: `
  ...
  {
    id: 'sygnaly-stresu',
    title: 'Sygnały stresu u psa u fryzjera – jak pracujemy w hOla Perros?',
    excerpt: 'Pies nie zawsze musi uciekać, by okazać strach. Odkrywamy mowę ciała psów w salonie.',
    date: '05 Czerwiec 2026',
    category: 'Edukacja i Wychowanie',
    imageUrl: './zdjecia/blog/bezstresowy-grooming-psa-raciborz.webp?v=2',
    content: `
  ...
  {
    id: 'opieka-zimowa-letnia',
    title: 'Jak samodzielnie dbać o psie łapki zimą i latem?',
    excerpt: 'Ekstremalne warunki pogodowe mogą zniszczyć opuszki Twojego psa. Oto porady od groomera.',
    date: '08 Czerwiec 2026',
    category: 'Zdrowie i Uroda',
    imageUrl: './zdjecia/blog/pielegnacja-lapek-psa-raciborz.webp?v=2',
    content: `
  ...
  {
    id: 'pielegnacja-dlugowlosych',
    title: 'Pielęgnacja ras długowłosych (York, Shih-Tzu) – sekrety pięknej szaty',
    ...
    category: 'Pielęgnacja domowa',
    imageUrl: './zdjecia/blog/strzyzenie-yorka-shih-tzu-raciborz.webp?v=2',
    content: `
